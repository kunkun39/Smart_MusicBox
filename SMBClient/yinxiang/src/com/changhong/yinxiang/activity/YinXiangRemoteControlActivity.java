        ...
        btn_center.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (code != VoiceRecognitionClient.START_WORK_RESULT_WORKING) {
                    Toast.makeText(YinXiangRemoteControlActivity.this, "网络连接出错，请重新尝试" , Toast.LENGTH_LONG).show();
                }
...
//    			return true;
    ...
    private void initBaiduConfiguration() {
        if (recognitionClient == null) {
            recognitionClient = VoiceRecognitionClient.getInstance(YinXiangRemoteControlActivity.this);
    ...
    public class BaiDuVoiceChannelDialogRecogListener implements VoiceRecognitionClient.VoiceClientStatusChangeListener {
        ...
        public void onError(int errorType, int errorCode) {
            Toast.makeText(YinXiangRemoteControlActivity.this, "抱歉哟，我们不能识别空指令" , Toast.LENGTH_LONG).show();
            isRecognitioning = false;
            recognitionClient.stopVoiceRecognition();
        }
        ...
        private void updateRecognitionResult(Object result) {
            ...
            if (StringUtils.hasLength(recognitionResult)) {
                ...
                if (StringUtils.hasLength(commands)) {
                    ...
                    hasResult = true;
                    Toast.makeText(YinXiangRemoteControlActivity.this, "语音的结果为:" + recognitionResult, Toast.LENGTH_LONG).show();
                    ...
                    if (StringUtils.hasLength(bestPostion)) {
                        ...
                        Toast.makeText(YinXiangRemoteControlActivity.this, "应用的结果为:" + info.appName + "\n语音的结果为:" + recognitionResult, Toast.LENGTH_LONG).show();
                        hasResult = true;
                    } else {
                        hasResult = false;
                    }
            ...
            if (!hasResult) {
                ...
                if (recognitioningFailedTimes == 3) {
                    ...
                    BaiDuVoiceChannelControlDialog yuYingHelpDialog = new BaiDuVoiceChannelControlDialog(YinXiangRemoteControlActivity.this);
                    yuYingHelpDialog.show();
                } else {
                    Toast.makeText(YinXiangRemoteControlActivity.this, "抱歉哟，目前还不支持该指令:" + recognitionResult, Toast.LENGTH_LONG).show();
                }
            } else {
                recognitioningFailedTimes = 0;
            }
