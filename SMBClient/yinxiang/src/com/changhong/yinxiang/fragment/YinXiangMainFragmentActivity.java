...
public class YinXiangMainFragmentActivity extends FragmentActivity {
	...
	private void initService() {
		 ...
		 * 启动get command服务
		 */
		Intent service1 = new Intent(YinXiangMainFragmentActivity.this,
		 ...
		 * 启动send command服务
		 */
		Intent service2 = new Intent(YinXiangMainFragmentActivity.this,
	...
	private void initViewAndEvent() {
		 ...
		 * Ip部分
		 */
		adapter = new BoxSelectAdapter(YinXiangMainFragmentActivity.this,
		...
		list.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ClientSendCommandService.serverIpList.isEmpty()) {
					Toast.makeText(YinXiangMainFragmentActivity.this,
	...
	private BroadcastReceiver updateReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context mContext, Intent mIntent) {
			...
			if (mIntent.getAction().equals("MAIN_UPDATE_DOWNLOAD")) {
				...
				if (!NetworkUtils
						.isWifiConnected(YinXiangMainFragmentActivity.this)) {
					return;
				}
				...
				Builder builer = new Builder(YinXiangMainFragmentActivity.this);
