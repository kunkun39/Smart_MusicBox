...
public class XiamiMainActivity extends BaseActivity {
	...
	public void initView() {
		...
		albumSongName1 = (TextView) findViewById(R.id.xiami_new_album1_name);
		albumSinger1 = (TextView) findViewById(R.id.xiami_new_album1_singer);
		albumMsg2 = (ImageView) findViewById(R.id.xiami_new_album2);
		playAlbum2 = (ImageView) findViewById(R.id.xiami_new_album2_play);
		albumSongName2 = (TextView) findViewById(R.id.xiami_new_album2_name);
		albumSinger2 = (TextView) findViewById(R.id.xiami_new_album2_singer);
		albumMsg3 = (ImageView) findViewById(R.id.xiami_new_album3);
		playAlbum3 = (ImageView) findViewById(R.id.xiami_new_album3_play);
		albumSongName3 = (TextView) findViewById(R.id.xiami_new_album3_name);
		albumSinger3 = (TextView) findViewById(R.id.xiami_new_album3_singer);
