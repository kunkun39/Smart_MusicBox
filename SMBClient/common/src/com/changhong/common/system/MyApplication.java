...
public class MyApplication extends Application {
	...
	/**
	 * pre load image loader, can't just let imageLoader load pre image, because
	 * maybe end user try to see picture, but at this moment, the imageLoader
	 * hasn't finish pre image load
	 */
	...
	public void onCreate() {
		...
		viewOptions = new DisplayImageOptions.Builder()
				...
				.cacheOnDisk(false).smallImageGenerate(true)
