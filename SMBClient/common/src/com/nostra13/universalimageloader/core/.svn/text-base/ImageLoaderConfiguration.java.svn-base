 ...
 * @see com.nostra13.universalimageloader.cache.memory.MemoryCache
 * @see com.nostra13.universalimageloader.cache.disc.DiskCache
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>memoryCache = {@link com.nostra13.universalimageloader.core.DefaultConfigurationFactory#createMemoryCache(int)}</li>
	 * <li>diskCache = {@link com.nostra13.universalimageloader.cache.disc.impl.UnlimitedDiscCache}</li>
	 * <li>imageDownloader = {@link com.nostra13.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(android.content.Context)}</li>
	 * <li>imageDecoder = {@link com.nostra13.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)}</li>
	 * <li>diskCacheFileNameGenerator = {@link com.nostra13.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()}</li>
	...
	public static class Builder {
		 ...
		 * memory cache. You can use {@link #memoryCache(com.nostra13.universalimageloader.cache.memory.MemoryCache)} method to set your own implementation of
		 * {@link com.nostra13.universalimageloader.cache.memory.MemoryCache}.
		 */
		 ...
		 * will be used as disk cache. You can use {@link #diskCache(com.nostra13.universalimageloader.cache.disc.DiskCache)} method for introduction your own
		 * implementation of {@link com.nostra13.universalimageloader.cache.disc.DiskCache}
		 */
		 ...
		 * <li>{@link #diskCacheFileNameGenerator(com.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator)}</li>
		 * </ul>
		 */
		 ...
		 * Default value -
		 * {@link DefaultConfigurationFactory#createImageDownloader(android.content.Context)
