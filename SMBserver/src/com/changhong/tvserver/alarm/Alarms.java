...
public class Alarms {
	...
	public static final String ALARM_ALERT_ACTION = "com.changhong.musicclocks.ALARM_ALERT";
	...
	public static final String ALARM_DONE_ACTION = "com.changhong.musicclocks.ALARM_DONE";
	...
	// ALARM_DONE_ACTION).
	public static final String ALARM_SNOOZE_ACTION = "com.changhong.musicclocks.ALARM_SNOOZE";

	// AlarmAlertFullScreen listens for this broadcast intent, so that other
	// applications
	// can dismiss the alarm (after ALARM_ALERT_ACTION and before
	// ALARM_DONE_ACTION).
	public static final String ALARM_DISMISS_ACTION = "com.changhong.musicclocks.ALARM_DISMISS";
	...
	public static long addAlarm(Context context, Alarm alarm) {
		...
		Log.i("sym", "timeinmillis=" + timeInMillis);
		if (alarm.enabled) {
	...
	public static void setNextAlert(final Context context) {
		if (!enableSnoozeAlert(context)) {
			Log.i("sym", "setnextalert");
			Alarm alarm = calculateNextAlert(context);
			//Log.i("sym", "timeinmills=" + alarm.time);
			if (alarm != null) {
				enableAlert(context, alarm, alarm.time);
			} else {
				Log.i("sym", "disablealert");
	...
	private static boolean enableSnoozeAlert(final Context context) {
		...
		Log.i("ZXXS", "enableSnoozeAlert id:"+id);
		if (id == -1) {
			return false;
		}
